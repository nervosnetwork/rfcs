...
| `uncles_hash`  | H256(hash)          | **The hash of the serialized uncle blocks data.** This will later be changed to using [Molecule Encoding](../0008-serialization/0008-serialization.md). |
